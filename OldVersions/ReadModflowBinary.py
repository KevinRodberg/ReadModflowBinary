...
#
  ...
  #
    ...
    if budget == 'FLOW_FRONT_FACE':
      ...
      rasterdir = os.path.join('IN_MEMORY',rasterdir)
      ...
      if csizeMultiplier > 1:
        ...
        rasMagResamp=r"IN_MEMORY/"+os.path.basename(rasMagResamp)
        rasDirResamp=r"IN_MEMORY/"+os.path.basename(rasDirResamp)
        ...
        inMemFCX = r'IN_MEMORY/' + os.path.basename(arrowFeatureX)
        ...
        if modelClips[optArgs['model']] != (0,0,0,0):
          ...
          inMemRasDirXclp = r'IN_MEMORY/clp' +\
                  os.path.basename(rasDirResamp)
          ...
          arcpy.RasterToPoint_conversion(in_raster=inMemRasDirXclp,
                          ...
                          raster_field="VALUE")
          inRasterListXclp = r'IN_MEMORY/clp'+\
                             os.path.basename(rasMagResamp)+\
                             ' Magnitude'
